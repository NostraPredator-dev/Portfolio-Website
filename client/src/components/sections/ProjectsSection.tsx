...
const projects: Project[] = [
  {
    ...
    description:
      "A responsive e-commerce platform with product listings, cart functionality, and user authentication.",
    category: "web",
    tags: ["JavaScript", "React", "Node.js"],
    links: {
      github: "https://github.com/NostraPredator-dev/E-Commerce",
      live: "https://e-commerce-1-ttr8.onrender.com/",
    },
  },
  {
    id: 2,
    title: "Weather App",
    description:
      "An Android application that shows the weather and temperature for cities around the world.",
    category: "mobile",
  ...
  },
  {
    ...
    title: "To-Do List",
    description:
      "A task management application that helps users organize and track their daily activities.",
    category: "web",
    tags: ["JavaScript", "HTML", "CSS"],
    links: {
      github: "https://github.com/NostraPredator-dev/To-Do-List",
      live: "https://nostrapredator-dev.github.io/To-Do-List/",
    },
  },
  {
    id: 4,
    ...
    description:
      "An interactive quiz application with multiple categories, score tracking, and timed challenges.",
    category: "web",
  ...
  },
  {
    ...
    title: "Bunny Game",
    description:
      "A 2D platformer game where players control a bunny character navigating through obstacles and collecting items.",
    category: "game",
  ...
  },
  {
    ...
    title: "IronMan Game",
    description:
      "An action game featuring Iron Man character with flying mechanics and combat abilities.",
    category: "game",
  ...
  },
  {
    ...
    title: "Hangman Game",
    description:
      "A classic word-guessing game with multiple difficulty levels and categories.",
    category: "game",
  ...
  },
  {
    ...
    title: "Worm Game",
    description:
      "A simple yet addictive snake-style game where the player controls a worm to collect food and grow longer.",
    category: "game",
